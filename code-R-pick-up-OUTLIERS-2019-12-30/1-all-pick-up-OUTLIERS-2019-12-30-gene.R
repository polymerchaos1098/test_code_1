...
data_folder = "/projectsp/foran/Team_Chan/STAR_FUSION_results/FFPE-new-data-10-2019/result-RSEM-genes"

file_name = "all_RSEM_genes_TPM.txt"

save_folder = "/projectsp/foran/Team_Chan/STAR_FUSION_results/FFPE-new-data-10-2019/result-R-pick-up-OUTLIERS-2019-12-30"

save_name = "result--for--all_RSEM_genes_TPM"
